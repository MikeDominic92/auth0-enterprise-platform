    ...
    <div class="flex flex-col gap-6">
       ...
       <div class="flex items-center justify-between mb-2">
        <div>
          ...
          <p class="page-subtitle">Manage your enterprise customers and tenants</p>
        </div>
      ...
      <mat-card class="card-shadow rounded-xl border-none overflow-hidden">
        <table mat-table [dataSource]="organizations" class="w-full">
          ...
          <ng-container matColumnDef="name">
            ...
            <td mat-cell *matCellDef="let element" class="pl-6 font-mono text-xs text-gray-600"> {{element.name}} </td>
          </ng-container>

          <!-- Display Name Column -->
          <ng-container matColumnDef="displayName">
            <th mat-header-cell *matHeaderCellDef> Display Name </th>
            <td mat-cell *matCellDef="let element" class="font-medium text-gray-900"> {{element.displayName}} </td>
          </ng-container>
          ...
          <ng-container matColumnDef="members">
            ...
            <td mat-cell *matCellDef="let element" class="text-gray-600 flex items-center gap-1"> 
          ...
          <ng-container matColumnDef="created">
            <th mat-header-cell *matHeaderCellDef class="pr-6"> Created </th>
            <td mat-cell *matCellDef="let element" class="pr-6 text-gray-500 text-sm"> {{element.created}} </td>
          </ng-container>
